  ...
  return (
    <section className="flex flex-col justify-around items-center gap-6 px-8 py-1 lg:flex-row">
      ...
      <div className="flex flex-col justify-center text-center lg:py-12 lg:text-left lg:w-1/2 xl:py-24">
        ...
        <p className="mb-8 leading-relaxed text-blue-800 lg:w-4/5 xl:text-lg">
        ...
        <div className="flex flex-col gap-2.5 md:flex-row lg:justify-start">
          <Link
            to="/explore"
            className=" inline-block rounded-lg bg-blue-500 border-2 border-black px-6 py-3 text-center text-sm font-semibold text-black transition duration-100 hover:bg-white hover:text-black md:text-base"
          >
           Load More
          </Link>
